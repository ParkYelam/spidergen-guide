...
ADialog.prototype.open = async function(viewUrl, parent, width, height)
{
	await AFrameWnd.prototype.open.call(this, viewUrl, parent, 0, 0, width, height);
};
